...
import verso.caixa.dto.CreateAcessoryRequestDTO;
...
public interface VehicleMapper {
    ...
    AccessoryModel toEntity(CreateAcessoryRequestDTO dto);
    ...
    Set<AccessoryModel> toAccessoryEntities(Set<CreateAcessoryRequestDTO> dtoSet);
